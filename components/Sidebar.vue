    ...
    <div class="flex flex-col h-full grow">
      ...
      <div class="flex-1 overflow-y-auto ">
        <UNavigationMenu
            ...
            :ui="{
              linkLeadingIcon: isCollapsed ? 'text-3xl ml-1.5' : 'text-lg',
            }"
        />
      </div>
...
const navLinks = computed(() => {
  ...
  const menuNew = menu.value.map(item => {
  ...
  menuNew.push({label: 'Верстка странички', icon: 'i-heroicons-rocket-launch', to: '/about'})
